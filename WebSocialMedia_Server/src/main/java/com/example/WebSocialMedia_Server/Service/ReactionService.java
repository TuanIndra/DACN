...
public class ReactionService {
    ...
    public Map<ReactionType, Long> countReactionsForComment(Long commentId) {
        ...
        public Map<String, Object> getReactionsForPost(Long postId, String username) {
            // Get reaction counts
            Map<ReactionType, Long> counts = countReactionsForPost(postId);

            // Get current user's reaction
            ReactionType userReaction = null;
            if (username != null) {
                Reaction reaction = reactionRepository.findByPostIdAndUserUsername(postId, username);
                if (reaction != null) {
            ...
            response.put("reactions", counts.entrySet().stream()
